define([
    ...
    'views/artists/oldportfolio'
],function($,_,Backbone,PortfolioContentMain,OldPortfolioParentView){

    var OldPortfolioView = OldPortfolioParentView.extend({
        ...
        resize : function(event){
            ...
            var height = $(window).height()-$('#menucontainer').height()-$('.modelpagetop').height()-52-10-28;
        ...
        showContentByIndex:function(index){
            ...
            //if ((contentLink.endsWith("mp4"))||(contentLink.endsWith("mov"))||(contentLink.endsWith("flv"))||(contentLink.endsWith("avi"))){
